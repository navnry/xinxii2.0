...
.web{background-color: $xinxii-theme-color;height: 100%;
	...
	.btn{width: 502rpx;height: 88rpx;background: #FCFCFC;border-radius: 4rpx;margin: 0 auto;background: #FCFCFC;font-size: 32rpx;line-height: 88rpx;color: $xinxii-theme-color;}
