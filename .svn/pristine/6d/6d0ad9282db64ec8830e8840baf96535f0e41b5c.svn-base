<template>
    <view class="content">
        ...
        <view class="search-box">
            <input type="text" disabled="disabled" @click="openUrl('./friendsearch')" placeholder="搜索" placeholder-class="input-pld">
            <x-icon class="img-search" color="rgba(25, 31, 37, 0.4)" size="32" type="search"></x-icon>
        </view>
        <!-- <view class="banner">
            <view class="top">
				...
				<view v-if="messageList.length>0">
					<view class="item" v-for="(item,index) in messageList" :key="index">
					    ...
					    <view class="bottom">
					        ...
					        <button class="btn" @click="forwarding(item)">一键朋友圈</button>
					    </view>
					</view>
...
.search-box{width: 100%; height: 104rpx; background-color: #fff; padding: 16rpx 0; position: relative;
    input{width: 702rpx; height: 72rpx; background: #F0F0F0; border-radius: 36rpx; margin: 0 auto; padding-left: 80rpx;}
    .input-pld{font-size: 28rpx; color: #999;}
    .img-search{position: absolute; left: 56rpx; top: 50%; transform: translateY(-50%); width: 32rpx; height: 32rpx;}
}
...
.friends{background: #fff; padding: 24rpx;margin: 24rpx;border-radius: 12rpx;
    ...
    .list{
        .item{ padding-bottom: 24rpx; border-bottom: 1px solid #f0f0f0;
            ...
            .top{font-size: 0; display: flex; align-items: center; font-weight: bold; margin: 24rpx 0;
                image{width: 80rpx; height: 80rpx; margin-right: 12rpx; border-radius: 6rpx;}
                .info{
                    .name{font-size: 32rpx; font-weight: bold; color: $xinxii-theme-color; line-height: 40rpx;}
                    .time{font-size: 24rpx; color: #999; margin-top: 2rpx;font-weight: 400;}
                }
            }
            .detail{
                .txt{font-size: 32rpx; line-height: 42rpx;}
                .img-box{font-size: 0; margin: 24rpx 0; border-radius: 16rpx;
                    image{ border-radius: 6rpx; width: 208rpx; height: 208rpx; margin: 15rpx 15rpx 0 0;}
                    &.img-box1{
                        // image{width: 372rpx; height: 494rpx;}
						image{width: 452rpx;height: 352rpx;border-radius: 6rpx;margin-top: 0;margin-right: 0;}
                    }
					&.img-box2{
						image{
            ...
            .bottom{display: flex; align-items: center; justify-content: space-between;
                ...
                .btn{width: 188rpx; height: 56rpx; line-height: 56rpx; background: $xinxii-theme-color; border-radius: 32rpx; color: #fff; font-size: 28rpx;}
            }
        }
    }
}
