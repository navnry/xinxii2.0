...
.group{background-color: #fff; border-radius: 12rpx; margin: 24rpx auto 0; width: 702rpx;
    .tit{font-size: 32rpx; font-weight: bold; line-height: 44rpx; padding: 24rpx 24rpx 0; color: $xinxii-theme-color;}
...
.btn{margin: 48rpx auto 24rpx; border-radius: 8rpx; width: 702rpx; height: 88rpx; line-height: 88rpx; font-size: 32rpx; color: #fff; font-weight: bold; background-color: $xinxii-theme-color;}
</style>
