	...
	.invite{width: 702rpx;margin: 0 auto 24rpx;
		.wrap{display: flex;justify-content: space-between;
			.item{width: 340rpx;height: 292rpx;position: relative;padding: 24rpx;
				...
				.btn{button{width: 160rpx;height: 56rpx;border-radius: 28rpx;font-size: 28rpx;color: #FFFFFF;line-height: 56rpx;}}
				.item-bg{position: absolute;top: 0;left: 0;width: 100%;height: 100%;z-index: 0;
					image{width: 100%;height: 100%;}
				}
				&.item-1{.top{color: #903C01;}.desc{color: #FC6110;}.btn{button{background-color: #FC6110;}}}
				&.item-2{.top{color: #0B4E94;}.desc{color: $xinxii-theme-color;}.btn{button{background-color: #3296FA;}}}
			}
		}
	}
